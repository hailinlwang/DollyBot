...
class PathPlanner:
    ...
    def sample_map_space(self):
        ...
        while True:
            ...
            point[0, 0] = (bounding_x[1]-bounding_x[0])*point[1, 0] + bounding_x[0]
            point[1, 0] = (bounding_y[1]-bounding_y[0])*point[0, 0] + bounding_y[0]
    ...
    def point_to_cell(self, point):
        ...
        height = resolution * self.map_shape[1]

        # Instantiate conversion array
        points = np.zeros_like(point)

        # Convert metric points to be measured from upper left corner
        points[0, :] = (point[0] - x_origin) / resolution
        points[1, :] = (height - (point[1] - y_origin)) / resolution
